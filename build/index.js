...
const periodic_check_1 = __importDefault(require("./controllers/periodic-check"));
...
//Run Cron Job
periodic_check_1.default.start(app_credentials_1.default.periodicCheckInterval);
